...
function GetKeyVaultSecret {
    ...
    if (-not $script:keyvaultConnectionExists) {
        ...
        $credentialsJson.subscriptionId = "xxx"
        $credentialsJson.tenantId = "xxx"
        $credentialsJson.clientId = "xxx"
        $credentialsJson.clientSecret = "xxx"
        $credentialsJson | ConvertTo-Json | Out-Host        
    }
