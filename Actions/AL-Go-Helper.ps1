...
function AnalyzeRepo {
    ...
    if (!$doNotCheckArtifactSetting) {
        $settings.artifact = CheckArtifactSetting -settings $settings -insiderSasToken $insiderSasToken -downloadArtifacts -doNotIssueWarnings:$doNotIssueWarnings
